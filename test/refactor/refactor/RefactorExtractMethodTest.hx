...
class RefactorExtractMethodTest extends RefactorTestBase {
	...
	function testLambdaExample(async:Async) {
		var edits:Array<TestEdit> = [
			makeReplaceTestEdit("testcases/methods/LambdaExample.hx", "processExtract", 156, 230, Format(2)),
	...
	function testLambdaExampleCallback(async:Async) {
		var edits:Array<TestEdit> = [
			makeReplaceTestEdit("testcases/methods/LambdaExample.hx", "processCallbackExtract", 281, 337, Format(2)),
			makeInsertTestEdit("testcases/methods/LambdaExample.hx",
	...
	function testLambdaExampleCallbackFunc(async:Async) {
		var edits:Array<TestEdit> = [
			makeReplaceTestEdit("testcases/methods/LambdaExample.hx", "processCallbackFuncExtract", 392, 453, Format(2)),
			makeInsertTestEdit("testcases/methods/LambdaExample.hx",
	...
	function testLambdaExampleSimple(async:Async) {
		var edits:Array<TestEdit> = [
			makeReplaceTestEdit("testcases/methods/LambdaExample.hx", "processSimpleExtract", 669, 679, Format(2)),
